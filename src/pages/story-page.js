...
const rawContent = [
        ...
        {type: "image", icon: "/img/hr-icon.png", data: "/img/hr101-info.png", title: "Other Examples of Harm Reduction", metadata: "A nationwide study showed that more than 80% of naloxone reversals were actually carried out by PWUD.", metadata2: "<div className = 'source-1'><span>>></span> Source: www.cdc.gov/ssp/syringe-services-programs-factsheet.html</div>"},
        //HEP&HIV
